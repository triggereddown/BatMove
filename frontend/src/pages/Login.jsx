...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-[4%] py-12 relative overflow-hidden" id="login-page">
      {/* Dynamic Background Element */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-accentPrimary/10 rounded-full blur-[100px] -z-10 animate-[pulse_6s_ease-in-out_infinite]" />
      ...
      <div className="w-full max-w-[420px] bg-glass border border-borderLayer rounded-[24px] p-8 md:p-10 shadow-[0_20px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl opacity-0 animate-[formSlideUp_0.8s_cubic-bezier(0.16,1,0.3,1)_forwards]">
        <div className="text-center mb-8">
          <h1 className="relative mb-3 font-heading text-4xl tracking-wide uppercase text-textPrimary group/header flex justify-center items-center overflow-hidden">
          ...
          <p className="text-textSecondary opacity-0 animate-[heroFadeIn_0.8s_ease_0.5s_forwards]">Sign in to your BatMove account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button type="submit" className="btn btn-lg btn-primary w-full justify-center mt-2 group relative overflow-hidden isolate" disabled={loading} style={{ animation: 'inputSlideUp 0.6s ease 0.8s forwards', opacity: 0 }}>
